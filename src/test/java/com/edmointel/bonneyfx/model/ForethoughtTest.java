...
public class ForethoughtTest {
    ...
    public void setUp() {
        ...
        insurance70Plan1 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 1);
        insurance70Plan2 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 2);
        insurance70Plan3 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 3);
        insurance70Plan5 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 5);
        insurance70Plan8 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 8);
        insurance70Plan10 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale70, 10);
        insurance80Plan1 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 1);
        insurance80Plan2 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 2);
        insurance80Plan3 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 3);
        insurance80Plan5 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 5);
        insurance80Plan8 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 8);
        insurance80Plan10 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale80, 10);
        insurance90Plan1 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 1);
        insurance90Plan2 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 2);
        insurance90Plan3 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 3);
        insurance90Plan5 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 5);
        insurance90Plan8 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 8);
        insurance90Plan10 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale90, 10);
        insurance99Plan1 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 1);
        insurance99Plan2 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 2);
        insurance99Plan3 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 3);
        insurance99Plan5 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 5);
        insurance99Plan8 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 8);
        insurance99Plan10 = new Forethought(Product.INSURANCE, Utils.toUSD("100.0"), sale99, 10);
        travel = new Forethought(Product.TRAVEL, Utils.toUSD("100.0"), sale70, 1);
        trust = new Forethought(Product.TRUST, Utils.toUSD("100.0"), sale70, 1);
